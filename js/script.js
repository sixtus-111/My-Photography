// change nav style on scrool
window.addEventListener('scroll', ()=> {
    document.querySelector('nav').classList.toggle('window-scrolled', window.scrollY > 0);
})


// CONTACT BUTTONS (CRICULAR TEXT BUTTONS)
...
textButtons.forEach(textButtons => {
    ...
    text.innerHTML = text.innerHTML.split('').map((Character, index) =>`<span style="transform: rotate(${index * 
